...
from data import get_service_account_info, leasing_scraper_data, leasing_funnel_data, inquiries_data, tours_data, vacancy_data, distinct_vacancy_data
...
competitors_tab, leasing_funnel_tab, application_funnel_tab, inquiries_tab, tours_tab, vacancy_tab = st.tabs(["Competitors", 'Leasing Funnel', 'Application Funnel', 'Inquiries', 'Tours', 'Vacancy'])
